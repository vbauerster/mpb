...
// effective only for bar which was constructed with `total <= 0`.
...
// If triggerCompleteNow is true then total value is set to current
// and complete event is triggered right away.
